import { getLocaleString, IWidgetControlProps, SchemaContainer, StateManagerContext, withReducer } from "@itsy-ui/core";
import { IModalStateProps, IModalStateTransitionProps, IShowModalEventArgs } from "./common";
...
export default withReducer("AppModal", reducer, mapDispatchToProps, stateJSON)(ItsyModalView);
